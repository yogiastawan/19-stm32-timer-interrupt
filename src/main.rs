...
#[entry]
fn main() -> ! {
    defmt::println!("STM32F103C8 Timer Interrupt with Input Capture");
    ...
    let channel_1 = gpioa.pa0.into_pull_down_input(&mut gpioa.crl);
    ...
    // 00 output
    // 01 input
    // 10 Input, (Cross-mapping channel 2).
